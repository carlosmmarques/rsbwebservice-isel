...
INSERT INTO posto_funcional(id, descricao, designacao) VALUES
  ...
  ('7', 'Sub Chefe 1ª', 'T/Ch 1ª'),
  ('8', 'Sub Chefe 1ª Classe', 'T/Ch 1ª Cl'),
  ('9', 'Sub Chefe 1ª Classe (Regime Mobilidade)', 'T/Ch 1ª RM'),
  ('10', 'Sub Chefe 2ª', 'T/Ch 2ª'),
  ('11', 'Sub Chefe 2ª Classe', 'T/Ch 2ª Cl'),
  ('12', 'Sub Chefe Principal', 'T/Ch Pr.'),
  ('13', 'Sub Chefe Principal (Regime Mobilidade)', 'T/Ch Pr. RM'),
...
INSERT INTO tipo_presenca(id, abreviatura, ausencia, descricao, reforco) VALUES
  ...
  ('T', 'Serviço Interno', FALSE, 'Serviços Internos Comandante Companhia / Batalhão / Secção', FALSE),
  ...
  ('3S', 'T/chefes  (Reforço)', FALSE, 'Sub Chefes', TRUE),
...
INSERT INTO tipo_presenca(id, abreviatura, ausencia, descricao, reforco, tipo_presenca_em_reforco_id) VALUES
  ...
  ('S3', 'T/chefes', FALSE, 'Sub Chefes', FALSE, '3S'),
...
INSERT INTO instalacao (id, descricao, designacao, localizacao, unidade_estrutural_id) VALUES
  ('1', 'Quartel - Sede', 'T', 'Av. Rio de Janeiro', '3'),
...
INSERT INTO pessoal (id, matricula, abreviatura, data_nascimento, e_mail, factor_elegibilidade, id_interno, nif, nome, num_doc_identificacao, num_mecanografico, telefone1, telefone2, tipo_doc_identificacao, instalacao_id, posto_funcional_id, tipo_presenca_id, turno_id) VALUES
  ...
  ('24', '4241', '', '02-01-1971', 'aderito.fernandes@cm-lisboa.pt', '0', '270', '200283154', 'Aderito Paulo de T Fernandes', '9588533', '13910', '963582731', '', 'BilheteIdentidade', '2', '11', 'S3', '3'),
  ...
  ('35', '4827', '', '09-06-1988', 'hugo.santos.nunes@cm-lisboa.pt', '0', '358', '254737943', 'Hugo Alexandre dos T. Nunes', '13336296', '955531', '915914276', '', 'BilheteIdentidade', '1', '5', 'S4', '1'),
  ...
  ('56', '4657', '', '30-11-1982', 'susana.pires@cm-lisboa.pt', '0', '517', '221367250', 'Susana Frederica da T. M. Pires', '12018662', '952234', '938526319', '', 'BilheteIdentidade', '1', '5', 'S4', '4'),
  ...
  ('89', '4335', '', '14-08-1971', 'jose.manuel.pinheiro@cm-lisboa.pt', '0', '742', '196101824', 'José Manuel dos T. Pinheiro', '9884835', '496646', '933210971', '', 'BilheteIdentidade', '2', '15', '0', '9'),
  ...
  ('96', '4775', '', '09-08-1982', 'bruno.teixeira@cm-lisboa.pt', '0', '797', '232124370', 'Bruno Miguel dos T. Teixeira', '12398488', '953724', '965756601', '', 'BilheteIdentidade', '1', '5', 'S4', '3'),
  ('97', '4747', '', '13-04-1978', 'carlos.s.rodrigues@cm-lisboa.pt', '0', '805', '222487437', 'Carlos António dos T.Rodrigues', '11304971', '953696', '933373815', '', 'BilheteIdentidade', '1', '5', 'S4', '1'),
  ...
  ('106', '4495', '', '19-04-1978', 'luis.fortunato@cm-lisboa.pt', '0', '1027', '210488000', 'Luis Filipe O. de T.Fortunato', '11284524', '950044', '969292525', '', 'BilheteIdentidade', '2', '15', 'S4', '9'),
...
;
INSERT INTO pessoal (id, matricula, abreviatura, data_nascimento, e_mail, factor_elegibilidade, id_interno, nif, nome, num_doc_identificacao, num_mecanografico, telefone1, telefone2, tipo_doc_identificacao, instalacao_id, posto_funcional_id, tipo_presenca_id, turno_id) VALUES
  ('111', '', '', '01-01-1970', '', '0', '0', '', '', '', '1', '', '', 'BilheteIdentidade', '1', '6', 'T', '2'),
  ...
  ('120', '', '', '01-01-1970', '', '0', '0', '', '', '', '10', '', '', 'BilheteIdentidade', '1', '5', 'T', '4'),
  ...
  ('136', '', '', '01-01-1970', '', '0', '0', '', '', '', '26', '', '', 'BilheteIdentidade', '1', '6', 'T', '4'),
...
INSERT INTO categoria (id, abreviatura, descrição, nivel_hierarquico, quadro) VALUES
  ...
  ('8', 'T/Ch.Pr', 'Subchefe Principal', '0', 'BOMBEIRO'),
  ('9', 'T/Ch.1a', 'Subchefe de 1.ª Classe', '0', 'BOMBEIRO'),
  ('10', 'T/Ch.2a', 'Subchefe de 2.ª Classe', '0', 'BOMBEIRO'),
...
INSERT INTO responsabilidade_operacional (id, depende_factor_elegibilidade, designacao, sigla, tipo_servico, tipo_presenca_id) VALUES
  ...
  ('2', TRUE, 'Chefe de Serviço à Cidade', 'CH CIDADE', 'EXTERNO', 'T'),
...
INSERT INTO presenca (id, data, hora_inicio, num_horas, instalacao_efectiva_id, periodo_id, pessoal_id, posto_funcional_efectivo_id, tipo_presenca_efectiva_id, turno_efectivo_id) VALUES
  ...
  ('73', '02-12-2015', '08:00', '12', '1', '1', '120', '5', 'T', '4'),
  ...
  ('116', '02-12-2015', '08:00', '12', '1', '1', '136', '6', 'T', '4'),
